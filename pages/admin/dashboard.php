            ...
            <div class="col-md-4">
                <div class="card text-white bg-success h-100">
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        <a href="../../forms/createUserPage.php" class="btn btn-light mt-3" aria-label="Ajouter un nouvel utilisateur">Ajouter</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card text-white bg-danger h-100">
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        <a href="../../actions/logout.php" class="btn btn-light mt-3" aria-label="Se déconnecter">Se déconnecter</a>
                    </div>
                </div>
            </div>
        </div>
